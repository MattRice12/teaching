...
// Push
  // 5) Push elements ("Matt", "Eric", "Crystal", "Corey", and "Tommy") into an array


// Pop
  // 6) Remove elements from the end of the array, ["Matt", "Eric", "Crystal", "Corey", "Tommy"]
...
// Join
  // 8) Join strings "Hello" and "World" with a .join (make sure there is a comma and a space between words)


// Split
  // 9) Split strings "category=animals&type=dogs" on "&"


  // 10) Split these further so we get an array of ["animals", "dogs"]
